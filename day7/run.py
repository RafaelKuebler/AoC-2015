...
def wire_value(circuit: Dict[str, Cable], element: str) -> Optional[int]:
    if element is None:
        return element
...
def solve(circuit: Dict[str, Cable], override: Optional[bool] = None) -> int:
    target = "a"
    if override is not None:
        circuit["b"].value = override
...
if __name__ == "__main__":
    ...
    solution2 = solve(build(steps), override=solution1)
    print(solution2)
